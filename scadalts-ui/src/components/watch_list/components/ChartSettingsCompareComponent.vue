      ...
      if (!!loadedData) {
        if (loadedData.type === this.CHART_TYPE) {
            for(let i = 0; i < loadedData.pointSettings.length; i++) {
                ...
                this.pointSettings[i].startDate = new Date(loadedData.pointSettings[i].startDate);
                this.pointSettings[i].startTime = new Date(loadedData.pointSettings[i].startTime);
