      ...
      <div class="modal-body-block">
        <div class="container">
          <div class="col-xs-12">
            <btn-group class="col-xs-8">
              <div class="col-xs-6">
                <btn block input-type="radio" v-model="aggregation.aggregate" :input-value="false">{{$t("modernwatchlist.chartseries.aggregation.all")}}</btn>
              </div>
              <div class="col-xs-6">
                <btn block input-type="radio" v-model="aggregation.aggregate" :input-value="true">{{$t("modernwatchlist.chartseries.aggregation.aggregate")}}</btn>
              </div>
            </btn-group>
            <div class="col-xs-4">
        ...
        <div class="container margin-top" v-if="tempSeries">
          <div class="col-xs-12 justify-content-md-center">
            <tabs justified>
              <tab v-for="s in tempSeries" :title="s.name" :key="s.id">
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.name")}}</p>
                  <div class="col-xs-6">
                    <input class="form-control" v-model="s.name" />
                  </div>
                </div>
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.series")}}</p>
                ...
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.yaxis")}}</p>
                  <btn-group class="col-xs-6">
                    <btn
                      class="col-xs-3"
                      input-type="radio"
                ...
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.xaxis")}}</p>
                  <btn-group class="col-xs-6">
                    <btn
                      class="col-xs-6"
                      input-type="radio"
                ...
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.stroke.color")}}</p>
                  <div class="col-xs-6">
                    <verte
                      picker="square"
                      v-model="s.stroke"
                ...
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.stroke.width")}}</p>
                  <div class="col-xs-6">
                    <input
                      class="form-control"
                      type="number"
                ...
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.stroke.tension")}}</p>
                  <div class="col-xs-6">
                    <input
                      class="form-control"
                      type="number"
                ...
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.fill.color")}}</p>
                  <div class="col-xs-6">
                    <verte
                      picker="square"
                      v-model="s.fill"
                ...
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.fill.opacity")}}</p>
                  <div class="col-xs-6">
                    <input
                      class="form-control"
                      type="number"
                ...
                <div class="col-xs-12">
                  <p class="col-xs-6">{{$t("modernwatchlist.chartseries.bullets")}}</p>
                  <btn-group class="col-xs-6">
                    <btn
                      class="col-xs-6"
                      input-type="radio"
          ...
          <div class="col-xs-12 margin-top">
              <div class="col-xs-4">
                  <btn block @click="close">{{$t("modernwatchlist.chartseries.close")}}</btn>
              </div>
              <div class="col-xs-4">
                  <btn block @click="restore">{{$t("modernwatchlist.chartseries.restore")}}</btn>
              </div>
              <div class="col-xs-4">
                  <btn type="primary" block @click="save">{{$t("modernwatchlist.chartseries.save")}}</btn>
              </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
      ...
      saveAggregation() {
        localStorage.setItem(`MWL_${this.watchListName}_A`, JSON.stringify(this.aggregation))
      },
...
.modal-block{
    ...
    height: 100vh;
    z-index: 100;
    background-color: rgba(0,0,0,.357);
}
.modal-body-block{ 
    margin: 5%;
    padding: 15px;
