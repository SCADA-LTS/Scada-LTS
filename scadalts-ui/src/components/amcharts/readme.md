...
```
<div id="line-chart" point-id="[dataPointID]"/>
```
That's it!\
...
### Live Data
```
<div id="line-chart" point-id="[dataPointID]" refresh-rate="10000"/>
```
...
```
<div id="line-chart" point-id="[dataPointID],[anotherDataPointID],[andNextDataPointID"]/>
```
...
```
<div id="line-chart" point-id="[dataPointID]" refresh-rate="10000" start-date="1-day"/>
```
...
```
<div id="line-chart" point-id="[dataPointID]" start-date="2019/02/01" end-date="2019/03/01"/>
```
...
```
<div id="line-chart" point-id="[dataPointID]" range-value="100" range-color="#FF0000" range-label="boiling"/>
```
...
```
<div id="line-chart" point-id="[dpID],[dpID_2],[dpID_3]" color="#FFFC19, #0971B3, #B31212"/>
```
...
### Chart Size
```
<div id="step-line-chart" point-id="[dpID]" width="1080" height="720"/>
```
...
### Labels
```
<div id="step-line-chart" point-id="[dpID]" label="Mid season temperature"/>
```
