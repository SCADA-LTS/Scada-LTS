		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-8">
					<!-- <CMP  /> -->
					<h4>test</h4>
					<CMP id="app-cmp-0"  pdebugRequest=false pstartLate=true pxIdViewAndIdCmp=1 ptimeOut=500 prunDirectly=true plabel='Beckenentleerung' ptimeRefresh=1000 pConfig='{
  "state": {
    "analiseInOrder": [
      {
        "name": "SPS OFFLINE",
