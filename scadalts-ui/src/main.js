      ...
      render: (h) =>
        h(CMP, {
          ...
          props: {
            ...
            pConfig: window.document
              .getElementById(cmpId)
              .getAttribute("pconfig"),
    ...
    new Vue({
      render: (h) =>
        h(StepLineChartComponent, {
          props: {
            pointId: window.document
              .getElementById(chartId)
              .getAttribute("point-id"),
            pointXid: window.document
              .getElementById(chartId)
              .getAttribute("point-xid"),
            color: window.document
              .getElementById(chartId)
              .getAttribute("color"),
            label: window.document
              .getElementById(chartId)
              .getAttribute("label"),
            startDate: window.document
              .getElementById(chartId)
              .getAttribute("start-date"),
            endDate: window.document
              .getElementById(chartId)
    ...
    render: (h) =>
      h(RefreshView, {
        props: {
          ...
          pviewId: window.document
            .getElementById("refresh-view")
            .getAttribute("pviewId"),
        },
      }),
  }).$mount("#refresh-view");
}
