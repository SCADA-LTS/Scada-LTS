...
public class PostgresMaintenanceEventDAO implements IMaintenanceEventDAO {
    ...
    public MaintenanceEventVO getMaintenanceEvent(int id) {
        ...
        return DAO.getInstance().getJdbcTemp().queryForObject(templateSelectWhereId, new Object[] {id}, new PostgresMaintenanceEventDAO.MaintenanceEventRowMapper());
    ...
    public MaintenanceEventVO getMaintenanceEvent(String xid) {
        ...
        try {
            maintenanceEvent = DAO.getInstance().getJdbcTemp().queryForObject(templateSelectWhereId, new Object[] {xid}, new PostgresMaintenanceEventDAO.MaintenanceEventRowMapper());
    ...
    public List<MaintenanceEventVO> getMaintenanceEvents() {
        ...
        return DAO.getInstance().getJdbcTemp().query(MAINTENANCE_EVENT_SELECT, new PostgresMaintenanceEventDAO.MaintenanceEventRowMapper());
    }
    ...
    public int insert(final MaintenanceEventVO maintenanceEvent) {
        ...
        if (LOG.isTraceEnabled()) {
            LOG.trace("insert(MaintenanceEventVO maintenanceEvent) maintenanceEvent:" + maintenanceEvent);
        }

        return DAO.getInstance().getJdbcTemp().queryForObject(
                MAINTENANCE_EVENT_INSERT,
                new Object[] {
