...
public class PostgresReportInstanceDAO implements IReportInstanceDAO {
    ...
    public ReportInstance getReportInstance(int id) {
        ...
        try {
            reportInstance = DAO.getInstance().getJdbcTemp().queryForObject(REPORT_INSTANCE_SELECT_WHERE_ID, new Object[]{id}, new PostgresReportInstanceDAO.ReportInstanceRowMapper());
    ...
    public List<ReportInstance> getReportInstances(int userId) {
        ...
        return DAO.getInstance().getJdbcTemp().query(REPORT_INSTANCE_SELECT_WHERE_USER_ID_ORDER, new Object[]{userId}, new PostgresReportInstanceDAO.ReportInstanceRowMapper());
    }
    ...
    public int insert(final ReportInstance reportInstance) {
        if (LOG.isTraceEnabled()) {
            LOG.trace("insert(ReportInstance reportInstance) reportInstance:" + reportInstance);
        }
    ...
    public List<ReportInstance> getReportInstances() {
        ...
        return DAO.getInstance().getJdbcTemp().query(REPORT_INSTANCE_SELECT, new PostgresReportInstanceDAO.ReportInstanceRowMapper());
    }
