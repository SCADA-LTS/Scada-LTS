...
public class V2_8_0__PostgresAddAssigneeColumnsToEvents extends BaseJavaMigration {

    private static final Logger LOG = LoggerFactory.getLogger(V2_8_0__PostgresAddAssigneeColumnsToEvents.class);
