...
public class V1_3__PostgresSetXidPointHierarchy extends BaseJavaMigration {

    private static final Logger LOG = LoggerFactory.getLogger(V1_3__PostgresSetXidPointHierarchy.class);
