...
public class PostgresPointHierarchyDAO implements IPointHierarchyDAO {

    private static final Log LOG = LogFactory.getLog(PostgresPointHierarchyDAO.class);
    ...
    public PostgresPointHierarchyDAO() {
        //
    }
    ...
    public boolean updateTitle(int id, String title) {
        ...
        PostgresPointHierarchyDAO.cachedPointHierarchy = null;
        return rows > 0;
    }
