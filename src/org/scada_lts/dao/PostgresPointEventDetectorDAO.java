 ...
 */
public class PostgresPointEventDetectorDAO implements IPointEventDetectorDAO {

	private static final Log LOG = LogFactory.getLog(PostgresPointEventDetectorDAO.class);
