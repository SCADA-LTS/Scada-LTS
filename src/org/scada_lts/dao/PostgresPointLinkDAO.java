...
public class PostgresPointLinkDAO implements IPointLinkDAO {

    private static final Log LOG = LogFactory.getLog(PostgresPointLinkDAO.class);
    ...
    public PointLinkVO getPointLink(int id) {
        ...
        try {
            pointLinkVO = DAO.getInstance().getJdbcTemp().queryForObject(templateSelectWhereId, new Object[] {id}, new PostgresPointLinkDAO.PointLinkRowMapper());
    ...
    public PointLinkVO getPointLink(String xid) {
        ...
        PointLinkVO pointLinkVO;
        try {
            pointLinkVO = DAO.getInstance().getJdbcTemp().queryForObject(templateSelectWhereId, new Object[]{xid}, new PostgresPointLinkDAO.PointLinkRowMapper());
        } catch (EmptyResultDataAccessException e) {
            pointLinkVO = null;
        }
        return pointLinkVO;
    ...
    public List<PointLinkVO> getPointLinks() {
        ...
        return DAO.getInstance().getJdbcTemp().query(POINT_LINK_SELECT, new PostgresPointLinkDAO.PointLinkRowMapper());
    }
    ...
    public List<PointLinkVO> getPointLinksForPoint(int datapointId) {
        ...
        return DAO.getInstance().getJdbcTemp().query(POINT_LINK_SELECT_WHERE, new Object[]{datapointId, datapointId}, new PostgresPointLinkDAO.PointLinkRowMapper());
    }
