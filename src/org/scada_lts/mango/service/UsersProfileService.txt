...
import static org.scada_lts.mango.service.UsersProfileService_SQL_Statements.*;

class UsersProfileService_SQL_Statements {
    ...
    static final String PROFILES_SELECT_ORDER_BY_NAME = PROFILES_SELECT+ " order by u.name";
    ...
    static final String INSERT__DATA_USERS_PROFILES = "insert into dataPointUsersProfiles (dataPointId, userProfileId, permission) values (?,?,?)";
    static final String INSERT__WATCH_LIST_USERS_PROFILES = "insert into watchListUsersProfiles (watchlistId, userProfileId, permission) values (?,?,?)";
    static final String INSERT__VIEW_USERS_PROFILES = "insert into viewUsersProfiles (viewId, userProfileId, permission) values (?,?,?)";
    static final String DELETE__USERS_USERS_PROFILES = "delete from usersUsersProfiles where userId=?";
    static final String INSERT__DATA_SOURCE_USERS_PROFILES = "insert into dataSourceUsersProfiles (dataSourceId, userProfileId) values (?,?)";
...
public class UsersProfileService extends BaseService {
    ...
    public List<UsersProfileVO> getUsersProfiles() {
        if (currentProfileList == null) {
            currentProfileList = query(UsersProfileService_SQL_Statements.PROFILES_SELECT_ORDER_BY_NAME,
    ...
    public void updateProfile(UsersProfileVO profile) {
        ...
        ejt.update(UsersProfileService_SQL_Statements.PROFILES_UPDATE,
    ...
    private void saveRelationalData(final UsersProfileVO usersProfile) {
        ...
        ejt.batchUpdate(
                INSERT__DATA_SOURCE_USERS_PROFILES,
        ...
        ejt.batchUpdate(
                INSERT__WATCH_LIST_USERS_PROFILES,
                new BatchPreparedStatementSetter() {
                    public int getBatchSize() {
    ...
    public void grantUserAdminProfile(User user) {
        ejt.update(DELETE__USERS_USERS_PROFILES,
    ...
    //public void setWatchListService(WatchListDao dao) {
    //    this.watchListService = dao;
    //}
    public void setWatchListService(WatchListService dao) {
        this.watchListService = dao;
    }

    //public void setViewService(ViewDao dao) {
    //    this.viewService = dao;
    //}
    public void setViewService(ViewService dao) {
        this.viewService = dao;
    }
    ...
    public void deleteUserProfile(final int usersProfileId) {
        ...
        // Reset user profile
        for (Integer userId : queryForList(USERS_PROFILES_USERS_SELECT
