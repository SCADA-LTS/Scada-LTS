...
public class OnlyMigrationPointEventDetectorDAO extends PointEventDetectorDAO {

	private static final Log LOG = LogFactory.getLog(OnlyMigrationPointEventDetectorDAO.class);
