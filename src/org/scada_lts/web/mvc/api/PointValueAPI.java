...
public class PointValueAPI {
    ...
    /**
     * @param xid, sts, ets - id of datapoint, start timestamp, end timestamp
     * @param request
     * @return
     */
    @RequestMapping(value = "/api/point_value/getValuesFromTimePeriodXid/{xid}/{sts}/{ets}", method = RequestMethod.GET)
    public ResponseEntity<String> getValuesFromTimePeriodXid(@PathVariable("xid") String xid, @PathVariable("sts") long sts, @PathVariable("ets") long ets, HttpServletRequest request) {
        ...
        LOG.info("/api/point_value/getValuesFromTimePeriodXid/{xid}/{sts}/{ets} xid: " + xid + " sts: " + sts + " ets: " + ets);
