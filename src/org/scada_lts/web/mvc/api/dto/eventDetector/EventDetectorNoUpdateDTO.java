...
public class EventDetectorNoUpdateDTO extends EventDetectorDTO {
    private int duration;
    private int durationType;

    public EventDetectorNoUpdateDTO() {
    }

    public EventDetectorNoUpdateDTO(String xid, String alias, int alarmLevel, int duration, int durationType) {
    ...
    public PointEventDetectorVO createPointEventDetectorVO(DataPointVO dataPointVO) {
        ...
        ped.setDetectorType(PointEventDetectorVO.TYPE_NO_UPDATE);
