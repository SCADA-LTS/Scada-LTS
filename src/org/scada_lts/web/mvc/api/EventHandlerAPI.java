...
public class EventHandlerAPI {
    ...
    public ResponseEntity<EventHandlerVO> createEventHandlerTypePoint(@PathVariable("typeId") int typeId, @PathVariable("typeRef1") int typeRef1, @PathVariable("typeRef2") int typeRef2, @RequestBody @Valid EventHandlerPointDTO handler, HttpServletRequest request) {
    ...
    public ResponseEntity<EventHandlerVO> createEventHandlerTypeEmail(@PathVariable("typeId") int typeId, @PathVariable("typeRef1") int typeRef1, @PathVariable("typeRef2") int typeRef2, @RequestBody @Valid EventHandlerEmailDTO handler, HttpServletRequest request) {
        return createEventHandler(typeId, typeRef1, typeRef2, handler.createEventHandlerVO(), request);
    }

    @PostMapping(value = "/set/{typeId}/{typeRef1}/{typeRef2}/3", produces = "application/json")
    public ResponseEntity<EventHandlerVO> createEventHandlerTypeProcess(@PathVariable("typeId") int typeId, @PathVariable("typeRef1") int typeRef1, @PathVariable("typeRef2") int typeRef2, @RequestBody @Valid EventHandlerProcessDTO handler, HttpServletRequest request) {
        return createEventHandler(typeId, typeRef1, typeRef2, handler.createEventHandlerVO(), request);
    }

    @PostMapping(value = "/set/{typeId}/{typeRef1}/{typeRef2}/4", produces = "application/json")
    public ResponseEntity<EventHandlerVO> createEventHandlerTypeScript(@PathVariable("typeId") int typeId, @PathVariable("typeRef1") int typeRef1, @PathVariable("typeRef2") int typeRef2, @RequestBody @Valid EventHandlerScriptDTO handler, HttpServletRequest request) {
        return createEventHandler(typeId, typeRef1, typeRef2, handler.createEventHandlerVO(), request);
    }

    @PostMapping(value = "/set/{typeId}/{typeRef1}/{typeRef2}/5", produces = "application/json")
    public ResponseEntity<EventHandlerVO> createEventHandlerTypeSms(@PathVariable("typeId") int typeId, @PathVariable("typeRef1") int typeRef1, @PathVariable("typeRef2") int typeRef2, @RequestBody @Valid EventHandlerSmsDTO handler, HttpServletRequest request) {
        return createEventHandler(typeId, typeRef1, typeRef2, handler.createEventHandlerVO(), request);
    }

    @PutMapping(value = "/update/{typeId}/{typeRef1}/{typeRef2}", consumes = "application/json")
    public ResponseEntity<Map<String, String>> updateEventHandler(@PathVariable("typeId") int typeId, @PathVariable("typeRef1") int typeRef1, @PathVariable("typeRef2") int typeRef2, @RequestBody @Valid EventHandlerVO handler, HttpServletRequest request) {
