...
class PropertiesPointToJSONXid implements Serializable {
    ...
    public PropertiesPointToJSONXid(String chartColour, ChartRenderer chartRenderer, String descConfiguration, String dataSourceName, String dataSourceXId,
    ...
    public ResponseEntity<String> getProperties(@PathVariable("xid") String xid, HttpServletRequest request) {
        ...
        try {
            ...
            if (user != null) {
                ...
                PropertiesPointToJSONXid p = new PropertiesPointToJSONXid(
                        dpvo.getChartColour(),
                        dpvo.getChartRenderer(),
