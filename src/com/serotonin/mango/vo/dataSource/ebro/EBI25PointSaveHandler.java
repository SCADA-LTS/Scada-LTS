...
public class EBI25PointSaveHandler implements DataPointSaveHandler {
    ...
    public void handleSave(DataPointVO point) {
        ...
        // device all match.
        EBI25DataSourceVO ds = (EBI25DataSourceVO) DaoInstances.getDataSourceDao().getDataSource(point.getDataSourceId());
        ...
        new EBI25InterfaceUpdater().updateLogger(ds.getHost(), ds.getPort(), ds.getTimeout(), ds.getRetries(), locator);
    }
}
