...
public class DataPointSynchronizedRT extends DataPointRT implements IDataPointRT {
    ...
    public void scheduleTimeout(long fireTime) {
        synchronized (intervalLoggingLock) {
            ...
            if (vo.getIntervalLoggingType() == DataPointVO.IntervalLoggingTypes.INSTANT)
                value = PointValueTime.getValue(getPointValue());
    ...
    private synchronized PointValueTime getOldAndSetNew(PointValueTime newValue) {
        if(newValue == null) {
            return pointValue;
        }
    ...
    public void initialize() {
        ...
        PointValueTime pointValue = getOldAndSetNew(valueCache.getLatestPointValue());
