...
public class CreateMailingList {
    ...
    public CreateMailingList(String xid, String name, List<EmailRecipient> entries, String cronPattern, Boolean collectInactiveEmails, Set<Integer> inactiveIntervals) {
        this.xid = xid;
        this.name = name;
