...
@Controller
@RequestMapping(path = "/api/export/config/with-images")
public class ExportWithImagesConfigAPI {

    private static final Log LOG = LogFactory.getLog(ExportWithImagesConfigAPI.class);
    ...
    public ResponseEntity<String> exportProjectName(@PathVariable String projectName,
        ...
        ExportConfig exportConfig = ExportConfig.withImagesConfig(projectName, pointValuesMax, projectDescription);
