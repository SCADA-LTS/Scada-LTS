...
RUN apt update && apt install -y unzip wait-for-it && rm -rf /var/lib/apt/lists/* && unzip /usr/local/tomcat/webapps/Scada-LTS.war -d /usr/local/tomcat/webapps/Scada-LTS
