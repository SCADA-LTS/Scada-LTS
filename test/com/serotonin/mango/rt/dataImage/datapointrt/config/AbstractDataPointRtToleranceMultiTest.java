...
public abstract class AbstractDataPointRtToleranceMultiTest extends ConfigDataPointRtTest {

    private final List<Double> exepected;

    public AbstractDataPointRtToleranceMultiTest(DataPointSyncMode sync, Object value1, Object value2, Object value3,
                                                 int dataTypeId, String dataType, String startValue, double tolerance,
                                                 List<Double> exepected) {
