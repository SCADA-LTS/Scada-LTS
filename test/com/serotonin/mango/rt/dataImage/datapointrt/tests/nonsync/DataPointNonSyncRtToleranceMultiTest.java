...
import com.serotonin.mango.rt.dataImage.datapointrt.config.AbstractDataPointRtToleranceMultiTest;
...
public class DataPointNonSyncRtToleranceMultiTest extends AbstractDataPointRtToleranceMultiTest {
...
/*
    ...
    public DataPointNonSyncRtToleranceMultiTest(Object value1, Object value2, Object value3, double tolerance, List<Double> exepected) {
        super(DataPointSyncMode.MEDIUM, value1, value2, value3, DataTypes.NUMERIC, DataTypes.CODES.getCode(DataTypes.NUMERIC), "99", tolerance, exepected);
    }
}