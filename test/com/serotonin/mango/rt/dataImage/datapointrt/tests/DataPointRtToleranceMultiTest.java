...
public class DataPointRtToleranceMultiTest extends AbstractDataPointRtToleranceMultiTest {
...
/*
    ...
    public DataPointRtToleranceMultiTest(Object value1, Object value2, Object value3, double tolerance, List<Double> exepected) {
        super(DataPointSyncMode.LOW, value1, value2, value3, DataTypes.NUMERIC, DataTypes.CODES.getCode(DataTypes.NUMERIC), "99", tolerance, exepected);
    }
}