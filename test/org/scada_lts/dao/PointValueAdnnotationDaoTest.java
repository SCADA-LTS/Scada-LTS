...
public class PointValueAdnnotationDaoTest extends TestDAO{
	...
	public void test() {
		...
		// read
		  ...
		  PointValueAdnnotation pointValueAdnnotationNewLongText = pointValuesAdnnotationsDAO.findById(1);		  
		  boolean test1 = pointValueAdnnotationNewLongText.equals(pointValueAdnnotationAlphanumericLongText);
		  assertTrue(test1);
		  
		  PointValueAdnnotation pointValueAdnnotationNewShortText = pointValuesAdnnotationsDAO.findById(2);		  
		  boolean test2 = pointValueAdnnotationNewShortText.equals(pointValueAdnnotationAlphanumericShortText);
		  assertTrue(test2);
		  
		  PointValueAdnnotation pointValueAdnnotationNewImage1 = pointValuesAdnnotationsDAO.findById(3);		  
		  boolean test3 = pointValueAdnnotationNewImage1.equals(pointValueAdnnotationImage1);
		  assertTrue(test3);
		  
		  PointValueAdnnotation pointValueAdnnotationNewImage2 = pointValuesAdnnotationsDAO.findById(4);		  
