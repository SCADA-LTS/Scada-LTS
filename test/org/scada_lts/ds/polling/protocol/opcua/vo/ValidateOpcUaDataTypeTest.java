...
public class ValidateOpcUaDataTypeTest {
    ...
    public static Object[][] data() {
        return new Object[][] {
            {OpcUaBaseDataType.UNKNOWN, -Double.MAX_VALUE, false, Double.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, Double.MAX_VALUE, false, Double.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, -Float.MAX_VALUE, false, Float.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, Float.MAX_VALUE, false, Float.class.getSimpleName()},

            {OpcUaBaseDataType.UNKNOWN, Long.MIN_VALUE, false, Long.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, Long.MAX_VALUE, false, Long.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, ULong.MIN_VALUE, false, ULong.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, ULong.MAX_VALUE, false, ULong.class.getSimpleName()},

            {OpcUaBaseDataType.UNKNOWN, Byte.MIN_VALUE, false, Byte.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, Byte.MAX_VALUE, false, Byte.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, UByte.MIN_VALUE, false, UByte.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, UByte.MAX_VALUE, false, UByte.class.getSimpleName()},

            {OpcUaBaseDataType.UNKNOWN, Short.MIN_VALUE, false, Short.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, Short.MAX_VALUE, false, Short.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, UShort.MIN_VALUE, false, UShort.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, UShort.MAX_VALUE, false, UShort.class.getSimpleName()},

            {OpcUaBaseDataType.UNKNOWN, Integer.MIN_VALUE, false, Integer.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, Integer.MAX_VALUE, false, Integer.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, UInteger.MIN_VALUE, false, UInteger.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, UInteger.MAX_VALUE, false, UInteger.class.getSimpleName()},

            {OpcUaBaseDataType.UNKNOWN, "abc", false, String.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, Boolean.FALSE, false, Boolean.class.getSimpleName()},
            {OpcUaBaseDataType.UNKNOWN, Boolean.TRUE, false, Boolean.class.getSimpleName()},

            ///

            {OpcUaBaseDataType.NUMBER, -Double.MAX_VALUE, false, Double.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, Double.MAX_VALUE, false, Double.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, -Float.MAX_VALUE, false, Float.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, Float.MAX_VALUE, false, Float.class.getSimpleName()},

            {OpcUaBaseDataType.NUMBER, Long.MIN_VALUE, false, Long.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, Long.MAX_VALUE, false, Long.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, ULong.MIN_VALUE, false, ULong.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, ULong.MAX_VALUE, false, ULong.class.getSimpleName()},

            {OpcUaBaseDataType.NUMBER, Byte.MIN_VALUE, false, Byte.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, Byte.MAX_VALUE, false, Byte.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, UByte.MIN_VALUE, false, UByte.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, UByte.MAX_VALUE, false, UByte.class.getSimpleName()},

            {OpcUaBaseDataType.NUMBER, Short.MIN_VALUE, false, Short.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, Short.MAX_VALUE, false, Short.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, UShort.MIN_VALUE, false, UShort.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, UShort.MAX_VALUE, false, UShort.class.getSimpleName()},

            {OpcUaBaseDataType.NUMBER, Integer.MIN_VALUE, false, Integer.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, Integer.MAX_VALUE, false, Integer.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, UInteger.MIN_VALUE, false, UInteger.class.getSimpleName()},
            {OpcUaBaseDataType.NUMBER, UInteger.MAX_VALUE, false, UInteger.class.getSimpleName()},
            ...
            {OpcUaBaseDataType.UNUMBER, Long.MAX_VALUE, false, Long.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, ULong.MIN_VALUE, false, ULong.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, ULong.MAX_VALUE, false, ULong.class.getSimpleName()},

            {OpcUaBaseDataType.UNUMBER, Byte.MIN_VALUE, false, Byte.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, Byte.MAX_VALUE, false, Byte.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, UByte.MIN_VALUE, false, UByte.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, UByte.MAX_VALUE, false, UByte.class.getSimpleName()},

            {OpcUaBaseDataType.UNUMBER, Short.MIN_VALUE, false, Short.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, Short.MAX_VALUE, false, Short.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, UShort.MIN_VALUE, false, UShort.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, UShort.MAX_VALUE, false, UShort.class.getSimpleName()},

            {OpcUaBaseDataType.UNUMBER, Integer.MIN_VALUE, false, Integer.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, Integer.MAX_VALUE, false, Integer.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, UInteger.MIN_VALUE, false, UInteger.class.getSimpleName()},
            {OpcUaBaseDataType.UNUMBER, UInteger.MAX_VALUE, false, UInteger.class.getSimpleName()},
