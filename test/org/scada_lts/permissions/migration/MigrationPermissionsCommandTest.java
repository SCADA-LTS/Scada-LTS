...
public class MigrationPermissionsCommandTest {
    ...
    public void execute() {
        ...
        DataPointUserPermissionsService dataPointUserPermissionsService = new DataPointUserPermissionsService(dataPointUserDAO);
        ...
        MigrationPermissions migrationPermissions = new MigrationPermissionsCommand(usersProfileService,dataPointUserPermissionsService,dataSourceUserPermissionsService,watchListUserPermissionsService);
        migrationPermissions.execute(users, views);
    }
