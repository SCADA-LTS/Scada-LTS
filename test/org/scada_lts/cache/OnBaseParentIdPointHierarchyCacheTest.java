...
public class OnBaseParentIdPointHierarchyCacheTest {
    ...
    public OnBaseParentIdPointHierarchyCacheTest(int parentId, List<PointHierarchyNode> pointHierarchy,
    ...
    @Test
    public void when_getOnBaseParentId() throws Exception {
