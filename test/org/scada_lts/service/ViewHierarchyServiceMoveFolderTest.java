...
public class ViewHierarchyServiceMoveFolderTest extends TestDAO {
	...
	public void checkViewHierarchyDAOToMoveFolder() {
		...
		assertTrue(vhs.getAll().size()==3);
	    assertTrue(vhs.getNode(1).size()==0);
	    assertTrue(vhs.getNode(2).size()==0);
	    assertTrue(vhs.getNode(3).size()==0);
	    assertTrue(vhs.getNode(ViewHierarchyDAO.ROOT_ID).size()==3);	
	    ...
	    assertTrue(vhs.getNode(ViewHierarchyDAO.ROOT_ID).size()==2);	
	    
	    vhs.moveFolder(vhn3.getId(), vhn1.getId());
		
		assertTrue(vhs.getAll().size()==1);
	    assertTrue(vhs.getNode(vhn1.getId()).size()==2);
	    assertTrue(vhs.getNode(vhn2.getId()).size()==0);
	    assertTrue(vhs.getNode(vhn3.getId()).size()==0);
