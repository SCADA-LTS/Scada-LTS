            ...
            <v-container fluid>
                ...
                <v-row>
                    ...
                    <v-col cols="12" md="9" v-if="componentData.data.rotationEnabled">
                        <v-row>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="componentData.data.rotationDuration" label="Duration"/>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model="componentData.data.rotationAngle" label="Rotation angle"/>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-checkbox v-model="componentData.data.rotationLoop" label="Loop rotation"/>
                            </v-col>
                        </v-row>
                        <v-row>
                            <v-col cols="12" md="6">
                                <v-select v-model="componentData.data.rotationCondition" :items="conditions"
                                          label="Condition"/>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-text-field v-model="componentData.data.rotationBoundary" label="Condition value"/>
                            </v-col>
                        </v-row>
                    </v-col>
                ...
                <v-row>
                    <v-col cols="12" md="3">
                        <v-switch v-model="componentData.data.colorChangeEnabled" label="Color Change"/>
                    </v-col>
                    <v-col cols="12" md="9" v-if="componentData.data.colorChangeEnabled">
                        <v-row>
                            <v-col cols="12" md="3">
                                <v-text-field v-model="componentData.data.colorChangeBase" label="Base color"/>
                            </v-col>
                            <v-col cols="12" md="3">
                                <v-text-field v-model="componentData.data.colorChangeAlternate"
                                              label="Alternate color"/>
                            </v-col>
                            <v-col cols="12" md="3">
                                <v-select v-model="componentData.data.colorChangeCondition" :items="conditions"
                                          label="Condition"/>
                            </v-col>
                            <v-col cols="12" md="3">
                                <v-text-field v-model="componentData.data.colorChangeBoundary"
    ...
    export default {
        ...
        methods: {
            updateComponent() {
                ...
                if (this.componentData.data.label) this.changeComponentText(`${this.componentId}_label`, this.componentData.data.label);
            },
            startRefresh() {
                ...
                if (this.componentData.data.rotationEnabled) {
                    ...
                    if (this.componentData.data.rotationCondition === "Equal") {
                        if (type === "NumericValue") {
                            rotate = parseFloat(value) === parseFloat(this.componentData.data.rotationBoundary)
                        } else if (type === "MultistateValue") {
                            rotate = parseInt(value) === parseInt(this.componentData.data.colorChangeBoundary)
                        } else {
                    ...
                    if (rotate) {
                        this.rotateComponent(this.componentId, this.componentData.data.rotationDuration, this.componentData.data.rotationAngle, this.componentData.data.rotationLoop)
                    } else {
            ...
            validateColor(value, type) {
                if (this.componentData.data.colorChangeEnabled) {
                    ...
                    if (this.componentData.data.colorChangeCondition === "Equal") {
                        if (type === "NumericValue") {
                            color = (parseFloat(value) === parseFloat(this.componentData.data.colorChangeBoundary))
                                ? this.componentData.data.colorChangeBase : this.componentData.data.colorChangeAlternate;
                        } else if (type === "MultistateValue") {
                            color = (parseInt(value) === parseInt(this.componentData.data.colorChangeBoundary))
                                ? this.componentData.data.colorChangeBase : this.componentData.data.colorChangeAlternate;
                        } else {
                            color = (value === this.componentData.data.colorChangeBoundary)
                                ? this.componentData.data.colorChangeBase : this.componentData.data.colorChangeAlternate;
                        }
                    ...
                    if (color !== undefined) this.changeComponentColor(`${this.componentId}_background`, color);
                }
            }
