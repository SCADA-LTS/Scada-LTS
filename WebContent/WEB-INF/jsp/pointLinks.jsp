        ...
        PointLinksDwr.savePointLink(editingPointLink.id, $get("xid"), $get("sourcePointId"), $get("targetPointId"),
            ...
            if (response.hasMessages)
                ...
                if (editingPointLink.id == ${NEW_ID}) {
                    ...
                    setUserMessage("<spring:message code="pointLinks.pointLinkAdded"/>");
    ...
    <tr>
      <td valign="top">
        <div class="borderDiv">
          <table width="100%">
            <tr>
              <td>
                <span class="smallTitle"><spring:message code="pointLinks.pointLinks"/></span>
      ...
      <td valign="top" style="display:none;" id="pointLinkDetails">
        <div class="borderDiv">
          <table width="100%">
            <tr>
              <td><span class="smallTitle"><spring:message code="pointLinks.details"/></span></td>
              <td align="right">
          ...
          <table>
            ...
            <tr>
              ...
              <td class="formField"><select id="sourcePointId" onchange="sourcePointSelectChanged()" style="display:none;"><option></option></select></td>
            </tr>
            
            <tr>
              <td class="formLabelRequired"><spring:message code="pointLinks.target"/></td>
              <td class="formField"><select id="targetPointId" style="display:none;"><option></option></select></td>
            </tr>
            
            <tr>
              <td class="formLabel">
                <spring:message code="pointLinks.script"/>
            ...
            <tr>
              <td class="formLabelRequired"><spring:message code="pointLinks.event"/></td>
              <td class="formField">
                <select id="event">
                  <option value="<c:out value="<%= PointLinkVO.EVENT_CHANGE %>"/>"><spring:message code="pointLinks.event.change"/></option>
                  <option value="<c:out value="<%= PointLinkVO.EVENT_UPDATE %>"/>"><spring:message code="pointLinks.event.update"/></option>
                </select>
              </td>
            </tr>
            
            <tr>
              <td class="formLabel"><spring:message code="common.disabled"/></td>
