...
<mobileTag:page>
      ...
      <tr>
        ...
        <c:choose>
          <c:when test="${state.disabled}">
            <td colspan="2"><spring:message code="common.pointWarning"/></td>
          </c:when>
          <c:otherwise>
  ...
  <spring:message code="header.watchlist"/>:
  ...
  <a href="mobile_watch_list.shtm"><spring:message code="header.reload"/></a>
  
  <a href="mobile_logout.htm"><spring:message code="header.logout"/></a>
</mobileTag:page>