  ...
  <jsp:body>
    <script type="text/javascript">
        ...
        function switchChart(){
            if(isChartLive){
                var data = "<img src="+jQuery("#chartTemp").attr('src')+"/>";
                $("imageChartDiv").innerHTML = data;
                setTimeout(function(){getImageChartLive(calculatePeriod());}, 3000);
            }
        }
    ...
    <div class="watch-container">
      ...
      <div id="splitContainer" dojoType="SplitContainer" orientation="horizontal" sizerWidth="3" activeSizing="true" class="borderDiv" widgetId="splitContainer" style="width: 100%; resize:vertical;">
    ...
    <div id="imageChartDiv" class="chart"></div>
