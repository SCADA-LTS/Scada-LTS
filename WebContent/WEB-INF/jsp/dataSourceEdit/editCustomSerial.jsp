...
<script type="text/javascript">
	...
	function scanImpl() {
		DataSourceEditDwr.customSerialScan($get("timeout"), $get("retries"),
				$get("commPortId"), $get("baudRate"), $get("dataBits"),
				$get("stopBits"), $get("parity"), scanCB);
	}

	function saveDataSourceImpl() {
		DataSourceEditDwr.saveCustomSerialDataSource($get("dataSourceName"),
				$get("dataSourceXid"), $get("updatePeriods"),
				$get("updatePeriodType"), $get("commPortId"), $get("baudRate"),
	...
	function savePointImpl(locator) {
		...
		DataSourceEditDwr.saveCustomSerialPointLocator(currentPoint.id,
...
<c:set var="dsDesc">
	<fmt:message key="dsEdit.customSerial.desc" />
</c:set>
<c:set var="dsHelpId" value="customSerialDS" />
<%@ include file="/WEB-INF/jsp/dataSourceEdit/dsHead.jspf"%>

<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.commPortId" /></td>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.retries" /></td>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.baud" /></td>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.dataBits" /></td>
	<td class="formField"><sst:select id="dataBits"
			value="${dataSource.dataBits}">
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.stopBits" /></td>
	<td class="formField"><sst:select id="stopBits"
			value="${dataSource.stopBits}">
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.parity" /></td>
	<td class="formField"><sst:select id="parity"
			value="${dataSource.parity}">
			<sst:option value="0">
				<fmt:message key="dsEdit.modbusSerial.parity.none" />
			</sst:option>
			<sst:option value="1">
				<fmt:message key="dsEdit.modbusSerial.parity.odd" />
			</sst:option>
			<sst:option value="2">
				<fmt:message key="dsEdit.modbusSerial.parity.even" />
			</sst:option>
			<sst:option value="3">
				<fmt:message key="dsEdit.modbusSerial.parity.mark" />
			</sst:option>
			<sst:option value="4">
				<fmt:message key="dsEdit.modbusSerial.parity.space" />
			</sst:option>
		</sst:select></td>
</tr>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.timeout" /></td>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.commandFormat" /></td>
	<td class="formField"><sst:select id="commandFormat"
			value="${dataSource.commandFormat}">
			<sst:option value="0">
				<fmt:message key="dsEdit.customSerial.commandFormat.None" />
			</sst:option>
			<sst:option value="1">
				<fmt:message key="dsEdit.customSerial.commandFormat.CR_LF" />
			</sst:option>
			<sst:option value="2">
				<fmt:message key="dsEdit.customSerial.commandFormat.CR" />
			</sst:option>
			<sst:option value="3">
				<fmt:message key="dsEdit.customSerial.commandFormat.LF" />
			</sst:option>
			<!--
			<sst:option value="4">
				<fmt:message key="dsEdit.customSerial.commandFormat.HEX" />
			</sst:option>
			-->
		</sst:select></td>
</tr>
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.responseSameFormat" /></td>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.stopMode" /></td>
	<td class="formField"><sst:select id="stopMode"
			onchange="changeStopMode()" value="${dataSource.stopMode}">
			<sst:option value="0">
				<fmt:message key="dsEdit.customSerial.stopMode.nChar" />
			</sst:option>
			<sst:option value="1">
				<fmt:message key="dsEdit.customSerial.stopMode.charX" />
			</sst:option>
			<!--
			<sst:option value="2">
				<fmt:message key="dsEdit.customSerial.stopMode.stopTimeout" />
			</sst:option>
			-->
		</sst:select></td>
</tr>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.nChar" /></td>
	<td class="formField"><input id="nChar" type="text"
		value="${dataSource.nChar}" /></td>
</tr>
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.charStopMode" /></td>
	<td class="formField"><sst:select id="charStopMode"
			onchange="changeCharStopMode()" value="${dataSource.charStopMode}">
			<sst:option value="0">
				<fmt:message key="dsEdit.customSerial.charStopMode.charASCII" />
			</sst:option>
			<sst:option value="1">
				<fmt:message key="dsEdit.customSerial.charStopMode.hexValue" />
			</sst:option>
		</sst:select></td>
</tr>
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.charStopMode.charASCII" /></td>
	<td class="formField"><input id="charX" type="text"
		value="${dataSource.charX}" disabled="disabled" /></td>
</tr>
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.charStopMode.hexValue" /></td>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.stopTimeout" /></td>
...
<tr>
	<td class="formLabelRequired"><fmt:message
			key="dsEdit.customSerial.bufferSize" /></td>
...
<tag:pointList pointHelpId="customSerialPP">
	...
	<tr>
		<td class="formLabelRequired"><fmt:message
				key="dsEdit.customSerial.commandNumber" /></td>
	...
	<tr>
		<td class="formLabelRequired"><span id="firstCommandLbl"><fmt:message
				key="dsEdit.customSerial.firstCommand" /></span></td>
	...
	<tr>
		<td class="formLabelRequired"><span id="secondCommandLbl"><fmt:message
					key="dsEdit.customSerial.secondCommand" /></span></td>
	...
	<tr>
		<td class="formLabelRequired"><span
			id="secondExpectedResponseLbl"><fmt:message
					key="dsEdit.customSerial.secondExpectedResponse" /></span></td>
	...
	<tr>
		<td class="formLabelRequired"><span id="thirdCommandLbl"><fmt:message
					key="dsEdit.customSerial.thirdCommand" /></span></td>
