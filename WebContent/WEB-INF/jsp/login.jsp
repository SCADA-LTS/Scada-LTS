...
<tag:page onload="setFocus">
	...
	<div class="login-container"
		style="margin: 100px auto 10px auto; background-color: #77c055; width: 290px; border-radius: 10px;">

		<div class="login-browser"
			style="text-align: center; padding-top: 10px;">

			<b><span id="browser"><fmt:message
						key="login.unknownBrowser" /></span></b> <img id="browserImg"
				src="images/magnifier.png" style="height: 10px; width: auto;" /> <span
				id="okMsg" style="display: none"><fmt:message
					key="login.supportedBrowser" /></span> <span id="warnMsg"
				style="display: none"><fmt:message
					key="login.unsupportedBrowser" /></span>
		</div>
			...
			<form action="login.htm" method="post" onclick="nag()"
				...
				<div class="form-box">
					...
					<div class="formField">
						<input id="username" type="text" name="username"
							value="${login.username}" maxlength="40"
				...
				<div class="form-box">
					...
					<div class="formField">
						<input id="password" type="password" name="password"
							value="${login.password}" maxlength="20"
							style="width: 200px; height: 20px;" />
					</div>
				</div>
				...
				<div class="login-button" align="center">
					<input type="submit" value="<fmt:message key="login.loginButton"/>"
						style="padding: 5px 20px; margin-left: 30%; margin-top: 10px;" />
