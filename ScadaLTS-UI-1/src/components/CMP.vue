      ...
      <div id="cmp">
        <div class="cmp-flex-container">
          ...
          <btn v-if="!disabledChange" class="cmp-flex-button" @click="show=!show">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="17px" height="17px" viewBox="0 0 900 900" style="enable-background:new 0 0 932.179 932.179;" xml:space="preserve">
              <g>
